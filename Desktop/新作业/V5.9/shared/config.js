// ===================================================================================
// ### shared/config.js (V5.2 - 已集成模块4.5彩蛋) ###
// ===================================================================================
...
module.exports = {
    ...
    // --- 文件保存路径 ---
    KEY_SAVE_PATH: "C:\\Users\\small\\Desktop\\AWS-ACCOUNT",
    ...
    ACCOUNT_PLAN_SELECTORS: {
        // 假设免费套餐的选项可以通过一个包含特定文本的元素来定位并点击
        freePlanOption: 'div.support-plan:has(h3:contains("Basic support - Free"))',
        // 这是您提供的需要点击的按钮
        submitButton: 'button.awsui-button-variant-primary[type="submit"][aria-label="Choose paid plan"]'
    },
